export const API_ENDPOINTS = {
  ...
  NOTIF_UPDATE_DISPATCH: '/notifications/update-dispatch',
  NOTIF_CREATE_DISPATCH: '/notifications/create-dispatch',
  NOTIF_RESERVED_SEATS: '/notifications/reserved-seats',
